    ...
    return (
        <div className="bg-blue-900">
            <div className="flex flex-row items-center w-full h-20">
                <div className="flex items-center text-xl text-white mx-10 px-6">
                    <NavLink className="hover:text-blue-300" to='/'>Home</NavLink>
                </div>
                <div className="flex flex-row justify-center items-center gap-x-36 text-xl w-screen text-white"> 
                ...
                <div className="flex w-40 items-center justify-center text-lg text-white h-100% mx-4">
                    ...
                    : <button className="border-2 border-blue-700 text-blue-700 bg-blue-300 h-12 rounded-lg p-2" onClick={() => connect()}>Connect Wallet</button>}
                </div>
            </div>
        </div>
    )
